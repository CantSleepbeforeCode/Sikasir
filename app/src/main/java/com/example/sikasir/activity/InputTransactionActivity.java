...
public class InputTransactionActivity extends AppCompatActivity {
    EditText iptIdBarang, iptUangBayar;
    Spinner iptSumBarang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!id.equals("")) {
                    ...
                    if (isExist.size() > 0) {
                        Toast.makeText(getApplicationContext(), "Data dengan Nama " + isExist.get(0).getName() + " Tersedia", Toast.LENGTH_SHORT).show();
        ...
        btnSimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String id = iptIdBarang.getText().toString();
                String sum = iptSumBarang.getSelectedItem().toString();
